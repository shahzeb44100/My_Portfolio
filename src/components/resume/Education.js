        ...
        <div className='mt-6 lgl:mt-14 w-full h-[1000px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10'>
          ...
          />
           <ResumeCard
            ...
            subTitle="IT Park"
            result="Summer 2020"
            des="Completed an internship at IT Park where I worked on developing web applications using React and Node.js. Gained practical experience in full-stack development and collaborative projects."
          />
        </div>
      </div>
    </motion.div>
